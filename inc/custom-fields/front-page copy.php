		...
		Field::make( 'complex', 'plt_front_slider', 'Объекты' )		
			->add_fields( array(
				...
				Field::make( 'select', 'type', 'Тип' )
					...
					->set_width(60),
				Field::make( 'oembed', 'video', 'Ссылка на видео' )->set_conditional_logic([['field' => 'type', 'value' => 'video']])->set_width(80),				
				Field::make( 'image', 'video_image_hover', 'Изображение при наведении' )->set_width(20)->set_conditional_logic([['field' => 'type', 'value' => 'video']]),
			))
