...
(() => {
    ...
    class Brands_Map {
            ...
            $.each(brandsData, function (key, data) {
                ...
                item = {
                    ...
                    'properties': {
                        ...
                        'balloonEmail': data.email,
                        'balloonWebsite': data.website,
                        'balloonUrl': data.url,
                    },
                    'options': {
        ...
        baloonConfig = () => {
            baloonParametrs = {
                content: '<div class="brand-baloon__left">' +
                    '<p class="brand-baloon__title">$[properties.balloonTitle]</p>' +
                    '<p class="brand-baloon__address">$[properties.balloonAddress]</p>' +
                    '</div>' +
                    '<div class="brand-baloon__right">' +
                    '<p class="brand-baloon__phone">$[properties.balloonPhone]</p>' +
                    '<p class="brand-baloon__email">$[properties.balloonEmail]</p>' +
                    '</div>' +
                    '<div class="clearfix">' +
                    '<a href="$[properties.balloonUrl]" class="btn btn--yellow btn--small">Подробнее</a>' +
                    '</div>',
                offset: [0, 0]
            };
