<form action="#" class="form form--color_white" name="form-consalt">
	<div class="row">
		<div class="col-md-6">
	...
	<div class="form__group form__group--footer"> 
		...
		<?php PLT_Content::nonce_field( 'form-consalt-nonce');?>
		<button class="btn run-form" type="submit"><span class="btn__inner"><span class="btn__text">Отправить заявку</span></span></button>
